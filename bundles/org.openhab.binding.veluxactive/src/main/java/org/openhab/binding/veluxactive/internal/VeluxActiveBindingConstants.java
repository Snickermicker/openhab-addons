...
public class VeluxActiveBindingConstants {
    ...
    // Gateway bridge
    public static final String THING_TYPE_GATEWAY = "nxg";
    public static final ThingTypeUID UID_NXG_BRIDGE = new ThingTypeUID(BINDING_ID, THING_TYPE_GATEWAY);
    public static final Set<ThingTypeUID> SUPPORTED_GATEWAY_BRIDGE_THING_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(UID_NXG_BRIDGE).collect(Collectors.toSet()));

    // Window, rollershutter and blinds bridge
    public static final String THING_TYPE_DEVICES = "devices";
    public static final ThingTypeUID UID_DEVICE_BRIDGE = new ThingTypeUID(BINDING_ID, THING_TYPE_DEVICES);
    public static final Set<ThingTypeUID> SUPPORTED_DEVICES_BRIDGE_THING_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(UID_DEVICE_BRIDGE).collect(Collectors.toSet()));

    // // Remote sensor thing
    // public static final String THING_TYPE_NXS = "nxs";
    // public static final ThingTypeUID UID_SENSOR_THING = new ThingTypeUID(BINDING_ID, THING_TYPE_NXS);
    // public static final Set<ThingTypeUID> SUPPORTED_SENSOR_BRIDGE_THING_TYPES_UIDS = Collections
    // .unmodifiableSet(Stream.of(UID_SENSOR_THING).collect(Collectors.toSet()));

    // Collection of window, rollershutter and blinds thing types
    public static final Set<ThingTypeUID> SUPPORTED_DEVICE_THING_TYPES_UIDS = SUPPORTED_DEVICES_BRIDGE_THING_TYPES_UIDS;

    // Collection of all supported thing types
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(UID_ACCOUNT_BRIDGE, UID_DEVICE_BRIDGE).collect(Collectors.toSet()));
    ...
    public static final String CONFIG_DEVICE_ID = "thermostatId";
    ...
    public static final HomesDataResponse EMPTY_HOUSEDETAILS = new HomesDataResponse();
    ...
    public static final String VELUXACTIVE_BASE_URL = "https://app.velux-active.com/";
    public static final String VELUXACTIVE_AUTHORIZE_URL = VELUXACTIVE_BASE_URL + "oauth2/token";
    public static final String VELUXACTIVE_TOKEN_URL = VELUXACTIVE_BASE_URL + "token";
    public static final String VELUXACTIVE_SCOPE = "smartWrite";
    public static final String VELUXACTIVE_DATETIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
}
