 ...
 */
package org.openhab.binding.veluxactive.internal.action;
...
import org.openhab.binding.veluxactive.internal.dto.thermostat.EventDTO;
import org.openhab.binding.veluxactive.internal.enums.AckType;
import org.openhab.binding.veluxactive.internal.enums.FanMode;
import org.openhab.binding.veluxactive.internal.enums.HoldType;
import org.openhab.binding.veluxactive.internal.enums.PlugState;
import org.openhab.binding.veluxactive.internal.enums.VentilatorMode;
import org.openhab.binding.veluxactive.internal.function.AcknowledgeFunction;
import org.openhab.binding.veluxactive.internal.function.ControlPlugFunction;
import org.openhab.binding.veluxactive.internal.function.CreateVacationFunction;
import org.openhab.binding.veluxactive.internal.function.DeleteVacationFunction;
import org.openhab.binding.veluxactive.internal.function.ResetPreferencesFunction;
import org.openhab.binding.veluxactive.internal.function.ResumeProgramFunction;
import org.openhab.binding.veluxactive.internal.function.SendMessageFunction;
import org.openhab.binding.veluxactive.internal.function.SetHoldFunction;
import org.openhab.binding.veluxactive.internal.function.SetOccupiedFunction;
import org.openhab.binding.veluxactive.internal.function.UpdateSensorFunction;
import org.openhab.binding.veluxactive.internal.handler.VeluxActiveDeviceBridgeHandler;
import org.openhab.binding.veluxactive.internal.handler.VeluxActiveUtils;
...
/**
 * The {@link VeluxActiveActions} defines the thing actions for the VeluxActive binding.
 *
 ...
 */
@Component(scope = ServiceScope.PROTOTYPE, service = VeluxActiveActions.class)
@ThingActionsScope(name = "veluxactive")
@NonNullByDefault
public class VeluxActiveActions implements ThingActions {

    private static final Logger LOGGER = LoggerFactory.getLogger(VeluxActiveActions.class);

    private @Nullable VeluxActiveDeviceBridgeHandler handler;

    public VeluxActiveActions() {
        LOGGER.debug("VeluxActiveActions: VeluxActiveActions: Actions service created");
    }

    @Override
    public void setThingHandler(@Nullable ThingHandler handler) {
        if (handler instanceof VeluxActiveDeviceBridgeHandler bridgeHandler) {
     ...
     * @see <a
     *      href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/Acknowledge.shtml">Acknowledge
     *      </a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean acknowledge(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'Acknowledge' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
        }
        AcknowledgeFunction function = new AcknowledgeFunction(localHandler.getDeviceId(), ackRef,
    ...
    public static boolean acknowledge(ThingActions actions, @Nullable String ackRef, @Nullable String ackType,
        ...
        return ((VeluxActiveActions) actions).acknowledge(ackRef, ackType, remindMeLater);
    }
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/ControlPlug.shtml">Control
     *      Plug</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean controlPlug(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'Control Plug' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean controlPlug(ThingActions actions, @Nullable String plugName, @Nullable String plugState,
        ...
        return ((VeluxActiveActions) actions).controlPlug(plugName, plugState, startDateTime, endDateTime, holdType,
                holdHours);
    }
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/CreateVacation.shtml">Create
     *      Vacation</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean createVacation(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'Create Vacation' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean createVacation(ThingActions actions, @Nullable String name,
        ...
        return ((VeluxActiveActions) actions).createVacation(name, coolHoldTemp, heatHoldTemp, startDateTime,
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/DeleteVacation.shtml">Delete
     *      Vacation</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean deleteVacation(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'Delete Vacation' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean deleteVacation(ThingActions actions, @Nullable String name) {
        return ((VeluxActiveActions) actions).deleteVacation(name);
    }
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/ResetPreferences.shtml">Reset
     *      Preferences</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean resetPreferences() {
        LOGGER.debug("VeluxActiveActions: Action 'Reset Preferences' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean resetPreferences(ThingActions actions) {
        return ((VeluxActiveActions) actions).resetPreferences();
    }
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/ResumeProgram.shtml">Resume
     *      Program</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean resumeProgram(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'Resume Program' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean resumeProgram(ThingActions actions, @Nullable Boolean resumeAll) {
        return ((VeluxActiveActions) actions).resumeProgram(resumeAll);
    }

    /**
     * The send message function allows an alert message to be sent to the thermostat.
     *
     * @see <a href="https://www.veluxactive.com/home/developer/api/documentation/v1/functions/SendMessage.shtml">Send
     *      Message</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean sendMessage(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'SendMessage' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean sendMessage(ThingActions actions, @Nullable String text) {
        return ((VeluxActiveActions) actions).sendMessage(text);
    }

    /**
     * Set an indefinite hold using the supplied the cool and heat hold temperatures
     *
     * @see <a href="https://www.veluxactive.com/home/developer/api/documentation/v1/functions/SetHold.shtml">Set
     *      Hold</a>
     */
    ...
    public static boolean setHold(ThingActions actions, @Nullable QuantityType<Temperature> coolHoldTemp,
        ...
        return ((VeluxActiveActions) actions).setHold(coolHoldTemp, heatHoldTemp);
    }
    ...
    public static boolean setHold(ThingActions actions, @Nullable QuantityType<Temperature> coolHoldTemp,
        ...
        return ((VeluxActiveActions) actions).setHold(coolHoldTemp, heatHoldTemp, holdHours);
    }

    /**
     * Set an indefinite hold using the supplied climateRef
     */
    // @RuleAction(label = "set the thermostat into hold", description = "The set hold function sets the thermostat into
    // a hold with the specified climate ref.")
    // public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean setHold(
    // @ActionInput(name = "holdClimateRef", description = "The holdClimateRef used to set the hold.") @Nullable String
    // holdClimateRef) {
    // VeluxActiveDeviceBridgeHandler localHandler = handler;
    // if (localHandler == null) {
    // LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
    ...
    // return ((VeluxActiveActions) actions).setHold(holdClimateRef);
    // }
    ...
    // {
    // return ((VeluxActiveActions) actions).setHold(holdClimateRef, holdHours);
    // }
    ...
    public static boolean setHold(ThingActions actions, @Nullable QuantityType<Temperature> coolHoldTemp,
            ...
            @Nullable Date startDateTime, @Nullable Date endDateTime, @Nullable String holdType,
            @Nullable Number holdHours) {
        return ((VeluxActiveActions) actions).setHold(coolHoldTemp, heatHoldTemp, holdClimateRef, startDateTime,
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean setHold(
            ...
            @ActionInput(name = "startDateTime", description = "(opt) The start date in thermostat time.") @Nullable Date startDateTime,
            @ActionInput(name = "endDateTime", description = "(opt) The end date in thermostat time.") @Nullable Date endDateTime) {
        LOGGER.debug("VeluxActiveActions: Action 'SetHold' called");
        if (params == null) {
        ...
        for (String key : params.keySet()) {
            ...
            if (value == null) {
                LOGGER.warn("Unrecognized event field '{}' with null value ignored.", key);
                continue;
            }
            switch (key) {
                case "isOccupied":
                ...
                case "isHeatOff":
                    ...
                    break;
                case "coolHoldTemp":
                    event.coolHoldTemp = VeluxActiveUtils.convertQuantityTypeToVeluxActiveTemp(value);
                    break;
                case "heatHoldTemp":
                    event.heatHoldTemp = VeluxActiveUtils.convertQuantityTypeToVeluxActiveTemp(value);
                    break;
                case "fan":
                ...
                case "coolRelativeTemp":
                    event.coolRelativeTemp = VeluxActiveUtils.convertQuantityTypeToVeluxActiveTemp(value);
                    break;
                case "heatRelativeTemp":
                    event.heatRelativeTemp = VeluxActiveUtils.convertQuantityTypeToVeluxActiveTemp(value);
                    break;
    ...
    public static boolean setHold(ThingActions actions, @Nullable Map<String, Object> params, @Nullable String holdType,
        ...
        return ((VeluxActiveActions) actions).setHold(params, holdType, holdHours, startDateTime, endDateTime);
    }
     ...
     *
     * @see <a href="https://www.veluxactive.com/home/developer/api/documentation/v1/functions/SetOccupied.shtml">Set
     *      Occupied</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean setOccupied(
            ...
            @ActionInput(name = "holdType", description = "(opt) The hold duration type. Valid values: dateTime, nextTransition, indefinite, holdHours.") @Nullable String holdType,
            @ActionInput(name = "holdHours", description = "(opt) The number of hours to hold for, used and required if holdType='holdHours'.") @Nullable Number holdHours) {
        LOGGER.debug("VeluxActiveActions: Action 'Set Occupied' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean setOccupied(ThingActions actions, @Nullable Boolean occupied, @Nullable Date startDateTime,
        ...
        return ((VeluxActiveActions) actions).setOccupied(occupied, startDateTime, endDateTime, holdType, holdHours);
    }
     ...
     *
     * @see <a href=
     *      "https://www.veluxactive.com/home/developer/api/documentation/v1/functions/UpdateSensor.shtml">Update
     *      Sensor</a>
     */
    ...
    public @ActionOutput(label = "Success", type = "java.lang.Boolean") Boolean updateSensor(
        ...
        LOGGER.debug("VeluxActiveActions: Action 'UpdateSensor' called");
        VeluxActiveDeviceBridgeHandler localHandler = handler;
        if (localHandler == null) {
            LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
            return false;
    ...
    public static boolean updateSensor(ThingActions actions, @Nullable String name, @Nullable String deviceId,
        ...
        return ((VeluxActiveActions) actions).updateSensor(name, deviceId, sensorId);
    }
    ...
    // LOGGER.debug("VeluxActiveActions: Action 'Get Alerts' called");
    // VeluxActiveDeviceBridgeHandler localHandler = handler;
    // if (localHandler == null) {
    // LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
    // return null;
    ...
    // return ((VeluxActiveActions) actions).getAlerts();
    // }
    ...
    // LOGGER.debug("VeluxActiveActions: Action 'Get Events' called");
    // VeluxActiveDeviceBridgeHandler localHandler = handler;
    // if (localHandler == null) {
    // LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
    // return null;
    ...
    // return ((VeluxActiveActions) actions).getEvents();
    // }
    ...
    // LOGGER.debug("VeluxActiveActions: Action 'Get Climates' called");
    // VeluxActiveDeviceBridgeHandler localHandler = handler;
    // if (localHandler == null) {
    // LOGGER.info("VeluxActiveActions: Action service ThingHandler is null!");
    // return null;
    ...
    // return ((VeluxActiveActions) actions).getClimates();
    // }
}
