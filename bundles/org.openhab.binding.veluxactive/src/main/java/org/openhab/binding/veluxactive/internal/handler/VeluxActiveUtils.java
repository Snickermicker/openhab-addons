...
/**
 * The {@link VeluxActiveUtils} contains utility methods used by the
 * thing handler and the bridge handler.
 *
 * @author Mark Hilbush - Initial contribution
 */
@NonNullByDefault
public final class VeluxActiveUtils {
    ...
    /*
     * Convert a QuantityType<Temperature> to the internal format used by the VeluxActive API.
     */
    @SuppressWarnings("unchecked")
    public static Integer convertQuantityTypeToVeluxActiveTemp(Object value) {
